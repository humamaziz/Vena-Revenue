...
const timeline = [
  ...
  { year: '2025', title: 'The Model Proven', desc: 'The diagnostic-first model validated. Clients recouped their audit investment within days of delivery. Full builds launched. The 2x guarantee has never been triggered. The retainer model locked in recurring revenue from clients who cannot afford to lose their AI search position.' },
...
const differentiators = [
  ...
  { icon: '🔒', title: 'Radical Risk Reversal', desc: 'If we do not document at least 2x the audit cost in recoverable revenue leaks, you receive a full refund immediately. We have never issued one because the leaks are always there.' },
  { icon: '🧬', title: 'Technical Moat', desc: 'MCP server architectures, headless Next.js decoupled builds, entity-graph JSON-LD injection. We build infrastructure that internal IT teams cannot replicate from off-the-shelf tools.' },
  ...
  { icon: '🎯', title: 'No Discovery Calls', desc: 'We do not ask for permission. We send a 90-second Loom showing you exactly what is broken before you spend a dollar. You see the leak before the conversation begins.' },
]
...
const targets = [
  ...
  { type: 'Medical Spas and Clinics', pain: 'High lifetime value, but structural lead capture failures. Phone-only booking losing 60%+ of mobile traffic.' },
